...
class Menu extends Component {
  ...
  visualizeAlgorithm = () => {
    this.props.onClick(this.state.algorithm);
  };
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
              <Nav className="me-auto">
                <Nav.Item>
                  <Nav.Link
                    target="new"
                    href="https://github.com/mygithub2015/pathfinding-in-action"
                  >
                    GitHub
                  </Nav.Link>
                </Nav.Item>
                ...
                >
                  ...
                  <NavDropdown.Item eventKey="Greedy BFS">
                    Gready Best-first Search
                  </NavDropdown.Item>
                  <NavDropdown.Item eventKey="BFS">
                    Breadth-first Search
                  </NavDropdown.Item>
                  <NavDropdown.Item eventKey="DFS">
                    Depth-first Search
                  </NavDropdown.Item>
                  <NavDropdown.Divider />
                  <NavDropdown.Item eventKey="Algorithms">
                    Reset
                  </NavDropdown.Item>
                </NavDropdown>
                <NavDropdown
                  title={this.state.maze}
                  id="collasible-nav-dropdown"
                  onSelect={this.selectMaze}
                >
                  <NavDropdown.Item eventKey="Recursive Division">
                    Recursive Division
                  </NavDropdown.Item>
                  <NavDropdown.Item eventKey="Recursive Division (vertical Skew)">
                    Recursive Division (vertical Skew)
                  </NavDropdown.Item>
                  <NavDropdown.Item eventKey="Recursive Division (horizontal Skew)">
                    Recursive Division (horizontal Skew)
                  </NavDropdown.Item>
                  <NavDropdown.Item eventKey="Basic Random Maze">
                    Basic Random Maze
                  </NavDropdown.Item>
                  <NavDropdown.Item eventKey="Basic Weight Maze">
                    Basic Weight Maze
                  </NavDropdown.Item>
                  <NavDropdown.Item eventKey="Simple Stair Pattern">
                    Simple Stair Pattern
                  </NavDropdown.Item>
                  <NavDropdown.Divider />
                  <NavDropdown.Item eventKey="Mazes & Patterns">
                    Reset
                  </NavDropdown.Item>
                </NavDropdown>
                <NavDropdown
                  title={this.state.clear}
                  id="collasible-nav-dropdown"
                  onSelect={this.clearBoard}
                >
                  <NavDropdown.Item eventKey="Clear Path">
                    Clear Path
                  </NavDropdown.Item>
                  <NavDropdown.Item eventKey="Clear Board">
                    Clear Board
                  </NavDropdown.Item>
                  <NavDropdown.Item eventKey="Clear Walls & Weights">
                    Clear Walls & Weights
                  </NavDropdown.Item>
                  <NavDropdown.Divider />
